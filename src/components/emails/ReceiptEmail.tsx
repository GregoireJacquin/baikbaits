...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Votre facture Baikbaits</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column>
              <Img
                src={`${process.env.NEXT_PUBLIC_SERVER_URL}/baik-email-sent.png`}
                width='100'
                height='100'
                alt='baikbaits'
              />
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Récapitulatif de la commande</Text>
          </Section>
